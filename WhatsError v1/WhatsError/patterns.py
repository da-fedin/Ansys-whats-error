...
'''
Contains all classes needed for WhatsError ACT extension
'''
class NullFile:
    """
    ...
    def read_file(self):
        ...
        #errorStr = 'WARNING: File %(name) not found' % {'name': self.file_path}
        errorStr = 'WARNING: File {} not found'.format(self.file_path)
        print(errorStr)
